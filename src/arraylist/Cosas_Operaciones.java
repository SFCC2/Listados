 ...
 * @author Asus-PC
 */
public class Cosas_Operaciones {

    int cont = 1;

    public static void main(String[] args) {
        Cosas_Operaciones admin = new Cosas_Operaciones();
        admin.ejecutar(admin);
    }

    public void ejecutar(Cosas_Operaciones admin) {
    ...
    public List<Cosas> crearLista(List<Cosas> pacientes, Cosas nueva, Cosas_Operaciones admin) {
    ...
    public void buscar(List<Cosas> pacientes, int a, String c, Cosas_Operaciones admin) {
    ...
    public List<Cosas> agregarAdicional(int r, List<Cosas> pacientes, Cosas nueva, Cosas_Operaciones admin) {
    ...
    public List<Cosas> eliminarTodo(List<Cosas> pacientes, Cosas_Operaciones admin) {
        pacientes.clear();
